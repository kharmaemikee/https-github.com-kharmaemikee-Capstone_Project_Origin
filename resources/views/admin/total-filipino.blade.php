            ...
            <div class="sidebar-header">
                <div class="sidebar-brand">
                    ...
                    <div class="brand-text">
                        <h4 class="brand-title">Admin Menu</n4>
                        ...
                        <tbody>
                            @forelse($filipinos as $filipino)
                                <tr class="table-row">
                                    ...
                                    <td class="name-cell">
                                        <div class="user-name">{{ $filipino->first_name }}</div>
                                    </td>
                                    <td class="name-cell">
                                        <div class="user-name">{{ $filipino->middle_name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="name-cell">
                                        <div class="user-name">{{ $filipino->last_name }}</div>
                                    </td>
                                    ...
                                    <td class="date-cell">
                                        <div class="date-info">
                                            ...
                                            {{ $filipino->created_at->format('M d, Y') }}
                                        </div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center empty-state-cell">
                                        <div class="empty-state">
                                            ...
                                            <h5 class="empty-title">No Filipino Users Found</h5>
