<x-app-layout>
                                ...
                                @foreach ($boatOwnerNotifications as $notification)
                                    <div class="notification-item {{ $notification->is_read ? 'read' : 'unread' }}" id="notification-{{ $notification->id }}" data-notification-id="{{ $notification->id }}">
                                        ...
                                        @if ($notification->booking)
                                            {{-- Guest Information (moved to top) --}}
                                            ...
                                            @if ($notification->booking->status === 'approved')
                                                @php
                                                    ...
                                                    // removed boat number display
                                                    $boatLength = $assignedBoatModel->boat_length ?? null;
                                                @endphp
                                                @if ($assignedBoatName)
                                                    <p class="mb-1"><strong>Boat No:</strong> #{{ $loop->iteration }}</p>
                                                    <div class="mt-2">
                                                        @if($assignedBoatName)
    ...
    <style>
        ...
        /* Hamburger Button Styles - Match with main navigation */
        .hamburger-btn {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            border: none;
            color: white;
        ...
        /* Responsive hamburger button styles */
