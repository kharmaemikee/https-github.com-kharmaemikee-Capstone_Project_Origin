<x-app-layout>
        ...
        <div class="main-content flex-grow-1">
            ...
            <div class="page-header">
                <div class="page-title-section">
                    ...
                    <p class="page-subtitle">{{ $room->resort->resort_name }} - Update room information and settings</p>
                </div>
            </div>
            ...
            <div class="form-container">
                <div class="form-card">
                    <form action="{{ route('resort.owner.rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Describe the room features, amenities, and special characteristics...">{{ old('description', $room->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('price_per_night') is-invalid @enderror" id="price_per_night" name="price_per_night" value="{{ old('price_per_night', $room->price_per_night) }}" required min="0" placeholder="0.00">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('max_guests') is-invalid @enderror" id="max_guests" name="max_guests" value="{{ old('max_guests', $room->max_guests) }}" required min="1" placeholder="1">
                                        @error('max_guests')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                @if ($room->image_path)
                                    <div class="current-image-container">
                                        ...
                                        <div class="current-image-wrapper">
                                            <img src="{{ asset($room->image_path) }}" alt="{{ $room->room_name }}" class="current-image">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                @if ($room->images && $room->images->count() > 0)
                                    <div class="current-images-container mt-3">
                                        <h6 class="current-images-title">
                                            <i class="fas fa-images me-1"></i>
                                            Current Additional Photos
                                        </h6>
                                        <div class="current-images-grid">
                                            @foreach ($room->images as $index => $roomImage)
                                                <div class="current-image-item">
                                                    <img src="{{ asset($roomImage->image_path) }}" alt="Room Image {{ $index + 1 }}" class="current-additional-image">
                                                    <div class="image-actions">
                                                        <input type="checkbox" class="form-check-input delete-additional-image" id="delete_additional_{{ $roomImage->id }}" name="delete_additional_images[]" value="{{ $roomImage->id }}">
                                                        <label class="form-check-label" for="delete_additional_{{ $roomImage->id }}">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group" id="rehabReasonContainer" style="display: none;">
                                ...
                                <textarea class="form-control @error('rehab_reason') is-invalid @enderror" id="rehab_reason" name="rehab_reason" rows="3" placeholder="Please provide details about the maintenance work...">{{ old('rehab_reason', $room->rehab_reason) }}</textarea>
                                @error('rehab_reason')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
    ...
    <style>
        ...
        .image-actions .form-check-input {
            margin: 0;
            width: 16px;
            height: 16px;
        }
        ...
        .image-actions .form-check-label:hover {
            color: #ff6b6b;
        }
