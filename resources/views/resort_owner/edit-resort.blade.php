                ...
                <form action="{{ route('resort.owner.update', $resort->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if($resort->image_path)
                            ...
                            <img src="{{ asset('storage/' . $resort->image_path) }}" class="img-thumbnail mt-2" style="max-width: 150px;" onerror="this.onerror=null;this.src='{{ asset('images/default_resort.png') }}';">
                        @else
