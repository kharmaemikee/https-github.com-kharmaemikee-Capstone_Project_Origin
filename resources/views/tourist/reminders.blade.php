    ...
    <div class="d-flex flex-column flex-md-row min-vh-100" style="background: linear-gradient(to bottom right, #d3ecf8, #f7fbfd);">
        ...
        <div class="p-3 d-none d-md-block" style="width: 250px; min-width: 250px; background-color: #2C3E50;">
            ...
            <ul class="nav flex-column mt-3">
                <li class="nav-item">
                    {{-- Changed route from tourist.list to tourist.tourist --}}
                    <a href="{{ route('tourist.tourist') }}" class="nav-link text-white rounded p-2 d-flex align-items-center justify-content-start"> {{-- Removed active class here, should be handled by current route --}}
                        {{-- Home Icon --}}
